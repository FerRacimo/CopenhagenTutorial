...
2) Is	that	what	you	would	expect	(the	mean	of	an	exponential	distribution	with rate	lambda	is	1/lambda	
...
4) Is	that	what	you	would	expect	(the	variance	of	an	exponential	is	1/(lambda^2)
